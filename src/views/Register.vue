            ...
            <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div class="w-full max-w-md space-y-8">
                    <div>
                        ...
                        <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Join our community</h2>
                    ...
                    <fieldset class="border-t border-gray-600">
                        <legend class="mx-auto px-4 text-gray-600  italic">Or continue with</legend>
                    </fieldset>
                    ...
                    <form class="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <div class="-space-y-px rounded-md shadow-sm">
                            ...
                            <div>
                                <label for="password" class="sr-only">Password</label>
                                <input id="passwordconfirm" name="password" type="password" autocomplete="current-password"
                                    required
